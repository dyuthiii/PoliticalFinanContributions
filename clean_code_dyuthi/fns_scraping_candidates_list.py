# -*- coding: utf-8 -*-
"""
Created on Tue Nov 26 14:59:39 2024
...
'''parallalezing code by makign it use multiple CPU cores'''
...
#Without parallelization!: comment everything below this main function, and uncomment this main function.
# def main():
...
#         candidates = candidate_df['name'].tolist()
...
def candidate_exists_in_db(db_path, candidate_name):
    """
